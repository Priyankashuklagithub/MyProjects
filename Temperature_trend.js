//Using NASA NEX GDDP dataset - Mean Temp. Trend
...
var outImage = output.first().select(['tasmin']);
...
var linearFit = ee.Image(collectionWithTime.select(['constant', 'tasmin']).reduce(ee.Reducer.linearFit()));
...
Export.image.toDrive({
  ...
  description: "lineartrend_Final_tasmin_2006to2100",
  region: ROI,
  scale: 25000, 
})
